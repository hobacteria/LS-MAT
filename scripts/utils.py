...
def controlnet_process_sample(noisy_latent, conditioning_sample,time_step,sex_index_tensor,modality_index_tensor,age_tensor, controlnet, unet,device,age_control = False):
